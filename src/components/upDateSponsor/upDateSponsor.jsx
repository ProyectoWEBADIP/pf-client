...
import { getAllSponsor,getSponsorById,updateSponsor } from '../../redux/sponsorActions/sponsorActions';
...
const UpDateSponsor = () => {
    ...
    const handleSubmit=(event)=>{
      ...
      if(enter){
        dispatch(updateSponsor(id,body))
        ...
        <div className='contenedor'>
          ...
          <div className='carta'>
              ...
              <div className='divboton'>
                <button onClick={handleSubmit} className='boton'>Guardar</button>
